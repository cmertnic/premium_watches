...
import watch_green from "@/public_img/welcome/watch_green.png";
import watch_quarts from "@/public_img/welcome/watch_quarts.png";
import watch_gold from "@/public_img/welcome/watch_gold.png";
import watch_black from "@/public_img/welcome/watch_black.png";
import watch_blue from "@/public_img/welcome/watch_blue.png";
  ...
  return (
    <main className={style.Main}>
      <div className={style.Main_row}>
        ...
        >
          <SwiperSlide><Image src={watch_green} alt={'watch_green'} width={436} height={255} /></SwiperSlide>
          <SwiperSlide><Image src={watch_quarts} alt={'watch_quarts'} width={436} height={255} /></SwiperSlide>
          <SwiperSlide><Image src={watch_gold} alt={'watch_gold'} width={436} height={255} /></SwiperSlide>
          <SwiperSlide><Image src={watch_black} alt={'watch_black'} width={436} height={255} /></SwiperSlide>
          <SwiperSlide><Image src={watch_blue} alt={'watch_blue'} width={436} height={255} /></SwiperSlide>
